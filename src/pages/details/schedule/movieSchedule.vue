<template>
    <div class="movie-schedule-wrap">
        ...
        <p v-if="currentPage < totalPage" class="load-more" @click="getMovieSchedule"><span>展开查看更多</span></p>
    </div>
</template>
...
<style scoped>
    ...
    .movie-schedule-con .movie-list{
        position: relative;
        box-sizing: border-box;
        width: 100%;
    }
    .movie-schedule-con .movie-list::before{
        position: absolute;
        content: '';
        top: 0;
        left: 6px;
    ...
    .movie-list li:first-child::before{
        left: -4px;
        top: 2px;
        width: 25px;
        height: 25px;
    ...
    .movie-schedule-con .movie-list li:last-child::after{
        position: absolute;
        content: '';
        bottom: 0;
        left: 6px;
    ...
    .movie-schedule-con .movie-list li:first-child::after{
        position: absolute;
        content: '';
        width: 0 !important;
    }
    .movie-schedule-con li .time{
        color: #8d72ff;
        font-size: 20px;
        font-weight: bold;
    }
    .movie-schedule-con li .introduction{
        width: 100%;
        overflow: hidden;
        white-space: normal;
        color: #666;
